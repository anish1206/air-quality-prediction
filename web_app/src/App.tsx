    ...
    <div className="relative w-screen h-screen overflow-hidden bg-[#060606] font-sans select-none">
      ...
      {isLayerPanelOpen && (
        ...
        ">
            ...
            {POLLUTANTS.map((p) => {
              ...
              return (
                <button
                  ...
                  className={`
                    w-full px-3 py-2.5 rounded-[10px] text-left
                ...
                >
                  ...
                  <div className={`text-[10px] leading-none mt-[4px] ${active ? 'text-white/60' : 'text-white/30'}`}>
                    {p.sub}
                  </div>
                </button>
              );
          ...
          {(() => {
            const active = POLLUTANTS.find((p) => p.key === selectedPollutant)!;
            return (
